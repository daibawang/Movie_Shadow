...
import com.sgcy.shadow.MovieAdapter.MoviecollectionAdapter;
...
public class MovieCollectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sc = (RecyclerView) findViewById(R.id.sc);
        movienums = (TextView) findViewById(R.id.moviesnum);
        //movies= LitePal.findAll(MovieCollection.class);
        movies = LitePal.where("collection==1").find(MovieCollection.class);
...
//                    notifyItemRangeChanged(0,holder.getAdapterPosition()+1);
        ...
        //下拉刷新//刷新布局
        mPtrFrame = (PtrClassicFrameLayout) findViewById(R.id.xl);
    ...
    public void loadnum(){
        int sqnum = LitePal.where("collection==?", "1").count(MovieCollection.class);
