...
import com.sgcy.shadow.MovieActivity.MovieCollectionActivity;
...
import com.sgcy.shadow.user.Information_Activity;
import com.sgcy.shadow.user.TagActivity;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.favorite:
                    ...
                    startActivity(i);
//                    Toast.makeText(MainActivity.this, "点击了昵称", Toast.LENGTH_SHORT).show();
                    break;

                case R.id.wallet:
                    Intent b = new Intent(MainActivity.this,Information_Activity.class);
                    startActivity(b);
//                    Toast.makeText(MainActivity.this, "点击了联系", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.photo:
                    Intent intent = new Intent(MainActivity.this, MovieCollectionActivity.class);
